...
public:
	...
	static URPGItem* CreateRPGGenericItem(URPGItemData* Data, const URPGItemBaseGenerationData* GenerationData, const bool bBuildItem = true, const int32 Quantity = 1);
	...
	static URPGItemStatOperation* CreateItemStatOperation(const TSubclassOf<URPGItemStatOperation> OperationClass, URPGItem* Item);
